#Proyecto de calculadora simple
...
multiplicacion = Button(root, text=' x ', fg='#fff', bg='#fe9727', command=lambda: press('*'))
...
igual = Button(root, text=' = ', fg='#fff', bg='#fe9727', command=equal_press)
